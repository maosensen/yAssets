...
export const T = {
	...
	export: {
		pickTitle: "选择导出目录",
		action: "导出",
		actionN: (n: number) => `导出（${n} 项）`,
		done: (n: number) => `已导出 ${n} 项`,
		empty: "没有可导出的素材",
	},
	colorFilter: {
		label: "颜色",
	...
	multi: {
		title: (n: number) => `已选中 ${n} 项`,
		trash: (n: number) => `移到回收站（${n} 项）`,
		restore: (n: number) => `恢复（${n} 项）`,
	},
	preview: {
		close: "关闭预览",
		prev: "上一张",
